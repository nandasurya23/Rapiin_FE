 ...
 return (
  <main className="page-enter mx-auto min-h-screen max-w-5xl px-4 py-8 sm:px-6 lg:px-10 space-y-8">
   ...
   <section className="animate-fade-up">
    <div className="rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 sm:p-8 md:p-10">
     ...
     <div className="relative grid gap-3 sm:grid-cols-2 md:grid-cols-4">
      <div className="rounded-xl bg-[var(--color-surface-elevated)] border border-[var(--color-border)] px-4 py-3 space-y-0.5">
       <p className="text-[10px] font-bold text-[var(--color-text)]/40 uppercase tracking-wider">Mode Operasional</p>
       <p className="text-xs font-black text-[var(--color-text)]/95">{business.mode.replace(/_/g, " ")}</p>
      </div>
      <div className="rounded-xl bg-[var(--color-surface-elevated)] border border-[var(--color-border)] px-4 py-3 space-y-0.5">
       <p className="text-[10px] font-bold text-[var(--color-text)]/40 uppercase tracking-wider">Kategori Bisnis</p>
       <p className="text-xs font-black text-[var(--color-text)]/95">{business.niche.replace(/_/g, " ")}</p>
      </div>
      <div className="rounded-xl bg-[var(--color-surface-elevated)] border border-[var(--color-border)] px-4 py-3 space-y-0.5">
