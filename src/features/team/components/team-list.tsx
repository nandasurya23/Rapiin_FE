 ...
 return (
  <div className="space-y-6">
   ...
   {filteredMembers.length > 0 ? (
    ...
    <div className="flex flex-col items-center justify-center py-16 text-center border border-dashed border-[var(--color-border)] rounded-2xl bg-[var(--color-surface-elevated)] p-6">
