...
export function OrderManager() {
 ...
 return (
  <main className="page-enter space-y-6 px-4 py-6 sm:px-6 lg:px-8" id="order-manager">
      ...
      <Button
       ...
       className={cn(
         ...
         subscriptionForCurrentBusiness?.planCode === "FREE_TRIAL" 
           ? "bg-[var(--color-surface-elevated)] text-[var(--color-text-muted)] border-[var(--color-border)] opacity-80 hover:bg-[var(--color-surface)]"
           : "bg-amber-100 text-amber-900 hover:bg-amber-200 hover:text-amber-900 border-amber-200"
       )}
      >
       {subscriptionForCurrentBusiness?.planCode === "FREE_TRIAL" ? (
   ...
   <section className="relative z-20 animate-fade-up-delay-1 pb-6 border-b border-[var(--color-border)]">
    <div className="grid gap-4 lg:grid-cols-[minmax(0,1.15fr)_minmax(320px,0.85fr)]">
     <div className="space-y-5 rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)]/60 backdrop-blur-md p-5 shadow-sm">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2">
       <label className="block">
        <span className="mb-2 block text-[10px] font-bold uppercase tracking-wider text-[var(--color-text-secondary)]">Filter Status Bayar</span>
        <Select
         value={paymentFilter}
       ...
       <label className="block">
        <span className="mb-2 block text-[10px] font-bold uppercase tracking-wider text-[var(--color-text-secondary)]">Status Pesanan</span>
        <FilterChipGroup
         options={[
     ...
     <div className="grid gap-3 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
      <div className="border border-[var(--color-border)] bg-[var(--color-surface)]/60 backdrop-blur-md shadow-sm p-4 flex flex-col justify-between rounded-2xl">
       <p className="text-[10px] font-bold uppercase tracking-wider text-[var(--color-info-text)]">Order Berjalan</p>
      ...
      <div className="border border-[var(--color-warning-border)] bg-[var(--color-surface)]/60 backdrop-blur-md shadow-sm p-4 flex flex-col justify-between rounded-2xl">
      ...
      <div className="border border-[var(--color-success-border)] bg-[var(--color-surface)]/60 backdrop-blur-md shadow-sm p-4 flex flex-col justify-between rounded-2xl">
