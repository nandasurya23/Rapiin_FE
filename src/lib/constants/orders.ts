...
export const ORDER_STATUS_TRANSITIONS_BY_MODE_FE: Record<string, Partial<Record<OrderStatus, OrderStatus[]>>> = {
  ...
  PRODUCT_ORDER: {
    ...
    DIPROSES: ["ORDER_BARU", "DIKIRIM_DIAMBIL", "SELESAI", "BATAL"],
    DIKIRIM_DIAMBIL: ["ORDER_BARU", "DIPROSES", "SELESAI", "BATAL"],
    SELESAI: ["ORDER_BARU", "DIPROSES", "DIKIRIM_DIAMBIL", "BATAL"],
    BATAL: ["ORDER_BARU", "DIPROSES", "DIKIRIM_DIAMBIL", "SELESAI"],
  },
  CUSTOM_REQUEST: {
    REQUEST_MASUK: ["DIBAHAS", "PENAWARAN_DIKIRIM", "DEAL", "SELESAI", "BATAL"],
    DIBAHAS: ["REQUEST_MASUK", "PENAWARAN_DIKIRIM", "DEAL", "SELESAI", "BATAL"],
    PENAWARAN_DIKIRIM: ["REQUEST_MASUK", "DIBAHAS", "DEAL", "SELESAI", "BATAL"],
    DEAL: ["REQUEST_MASUK", "DIBAHAS", "PENAWARAN_DIKIRIM", "SELESAI", "BATAL"],
    SELESAI: ["REQUEST_MASUK", "DIBAHAS", "PENAWARAN_DIKIRIM", "DEAL", "BATAL"],
    BATAL: ["REQUEST_MASUK", "DIBAHAS", "PENAWARAN_DIKIRIM", "DEAL", "SELESAI"],
  },
};
